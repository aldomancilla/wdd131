...
// const listItems = myInfo.favoriteFoods.map((favFood) => {
//     let listItem = document.createElement("li");
//     listItem.textContent = favFood;
//     return listItem;
//   });
  
//   const ulElement = document.querySelector("#favorite-foods");
//   listItems.forEach((listItem) => ulElement.appendChild(listItem));
